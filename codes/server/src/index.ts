  ...
  socket.on("message", (raw) => {
    try {
      ...
      if (message.type === "CREATE_ROOM") {
        ...
        else if (message.type === "CHAT") { room.chat(session.playerId, message.text, now); broadcastState(session.roomCode); }
